...
class CreditsControllerTest < ActionController::TestCase
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post :create, credit: { ctype: @credit.ctype, employee_id: @credit.employee_id, order_id: @credit.order_id, status: @credit.status, value: @credit.value }
    end
  ...
  test "should update credit" do
    patch :update, id: @credit, credit: { ctype: @credit.ctype, employee_id: @credit.employee_id, order_id: @credit.order_id, status: @credit.status, value: @credit.value }
    assert_redirected_to credit_path(assigns(:credit))
  end
