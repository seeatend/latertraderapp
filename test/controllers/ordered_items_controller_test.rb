...
class OrderedItemsControllerTest < ActionController::TestCase
  ...
  test "should create ordered_item" do
    assert_difference('OrderedItem.count') do
      post :create, ordered_item: { customer_id: @ordered_item.customer_id, offer_id: @ordered_item.offer_id, order_id: @ordered_item.order_id, seller_id: @ordered_item.seller_id }
    end
  ...
  test "should update ordered_item" do
    patch :update, id: @ordered_item, ordered_item: { customer_id: @ordered_item.customer_id, offer_id: @ordered_item.offer_id, order_id: @ordered_item.order_id, seller_id: @ordered_item.seller_id }
    assert_redirected_to ordered_item_path(assigns(:ordered_item))
  end
