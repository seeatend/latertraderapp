class GrowersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @grower.save
        format.html { redirect_to networks_path(:ntype => "grower"), notice: 'Grower was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @grower.update(grower_params)
        format.html { redirect_to networks_path(:ntype => "grower"), notice: 'Grower was successfully updated.' }
  ...
  def destroy
    @grower.destroy
    respond_to do |format|
      format.html { redirect_to networks_path(:ntype => "grower"), notice: 'Grower was successfully destroyed.' }
