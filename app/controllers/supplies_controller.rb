class SuppliesController < ApplicationController
  ...
  # GET /supplies.json
  def index
    @supplies = Supply.where(:seller_id => Seller.where(:uid => current_user.id).first.id)
  end
  ...
  private
    ...
    def supply_params
      params.require(:supply).permit(:grower_id, :consignment_number, :date_received, :ref_no, :value, :paid, :due, :status, :image, :employee_id,:seller_id)
    end
end
